...
if __name__ == "__main__":
    ...
    explosion2.rect.x = 415
    explosion2.rect.y = 300
    ...
    while run:
        ...
        if alien1.alive(): # alien이 아직 살아있는 동안에는 stone과의 충돌여부를 확인
            ...
            if collided: 
                ...
                explosion1.rect. y = \
                    ...
                    explosion1.rect.height/2 # 충돌한 경우에는 explosion 스프라이트의 위치를 alien객체가 있던 곳으로 옮기고 충돌 효과음 재생
                crash_sound.play()
                score += 5
        ...
        if not alien1.alive(): # alien이 돌에 맞아 죽었다면 폭발 애니매이션 재생
        ...
        if not explosion1.alive():
            ...
            alien1.rect.y = BASE_Y 
            alien_group = pygame.sprite.Group()
            alien_group.add(alien1) # explosion이 끝났을떄 새로운 alien 생성
